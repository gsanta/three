...
namespace spright { namespace tool {
	...
	void EraseTool::activate()
	{
		...
		m_TopLine = new engine::graphics::Sprite(-eraserSize / 2.0f, eraserSize / 2.0f, eraserSize, 0.1f, color);
		m_RightLine = new engine::graphics::Sprite(eraserSize / 2.0f, -eraserSize / 2.0f, 0.1f, eraserSize, color);
		m_BottomLine = new engine::graphics::Sprite(-eraserSize / 2.0f, -eraserSize / 2.0f, eraserSize, 0.1f, color);
		m_LeftLine = new engine::graphics::Sprite(-eraserSize / 2.0f, -eraserSize / 2.0f, 0.1f, eraserSize, color);
