...
export const initialBlockState: AddBlockState = {
...
export const addBlockSlice = createSlice({
  name: 'frame',
...
export const { setBlockSize, setBlockRotation, setColor, setSelectedGeometry, setSelectedTransformType } =
  addBlockSlice.actions;

export default addBlockSlice.reducer;
