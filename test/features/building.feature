Feature: Building
  Scenario: Adding walls to a building
    ...
    When I select a block at position 0,0,0 with part 'wall1'
    And I add template 'wall-1' with id 'wall-1' to the selected part
    Then parent for block 'wall-1' is 'base-1'
    And block 'wall-1' is in slot 'wall1' of block 'base-1'
    When I select a block at position 0,0,0 with part 'wall2'
    And I add template 'wall-1' with id 'wall-2' to the selected part
    Then parent for block 'wall-2' is 'base-1'
    And block 'wall-2' is in slot 'wall2' of block 'base-1'
  ...
  Scenario: Removing walls from a building
    ...
    And block 'wall-1' is not in slot 'wall1' of block 'base-1'
