...
class DrawHouseWiring {
  ...
  private getSelectedIntersection(rootBlock: BlockData, clientX: number, clientY: number, cableId?: string) {
  ...
  private getNewWirePoint(rootBlock: BlockData, intersection: BlockIntersection) {
