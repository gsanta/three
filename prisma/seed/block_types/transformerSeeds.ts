...
const transformerSeeds: (Omit<BlockType, 'animations' | 'decorations' | 'id' | 'parts' | 'partDetails'> & {
...
})[] = [
  {
    ...
    parts: [
      {
        index: '#1',
        geometryPath: 'nodes.Distribution_transformer1Body.geometry',
      ...
      {
        index: '#2',
        geometryPath: 'nodes.Distribution_transformer1Pin3.geometry',
        materialPath: 'Material',
      ...
      {
        index: '#3',
        geometryPath: 'nodes.Distribution_transformer1Pin2.geometry',
        materialPath: 'Material',
      ...
      {
        index: '#4',
        geometryPath: 'nodes.Distribution_transformer1Pin1.geometry',
        materialPath: 'Material',
